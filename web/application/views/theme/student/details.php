						...
						<div class="col-lg-12">
							...
							<form id="login-form" action = "<?=site_url('student/result');?>" method="post" role="form">
								<div class="form-group">
									<input type="text" name="reg_no" tabindex="2" class="form-control" pattern="[0-9]{2}/[A-Za-z]{3}/[0-9]{3}" title=" 13/ICS/047 " placeholder="Registration No." value="<?=set_value('reg_no');?>" required autofocus>
								</div>	
								<br/>
								<div class="form-group">
									<div class="row">
