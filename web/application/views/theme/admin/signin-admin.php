							...
							<div class="col-lg-12">
								<form id="login-form" action="<?=site_url('admin/main');?>" method="post" role="form" style="display: block;">
									...
									<div class="form-group text-center">
										<input type="checkbox" tabindex="12" class="" name="remember" id="remember">
										<label style="color:red;">Remember Me</label>
									</div>
									<div class="form-group">
										<div class="row">
											<div class="col-sm-6 col-sm-offset-3">
												<input type="submit" name="login-submit" id="login-submit" tabindex="13" class="form-control btn btn-login" value="Log In">
											</div>
										</div>
									</div>
									<div class="form-group">
										<div class="row">
											<div class="col-lg-12">
												<div class="text-center">
													<a href="http://phpoll.com/recover" tabindex="14" class="forgot-password">Forgot Password?</a>
												</div>
											</div>
										</div>
									</div>
