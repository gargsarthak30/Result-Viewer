...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 08, 2016 at 04:03 AM
...
CREATE TABLE IF NOT EXISTS `rs_faculty` (
  ...
  `Pass_Link` varchar(500) NOT NULL,
  `Timestamp` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
INSERT INTO `rs_faculty` (`Faculty_Id`, `Full_Name`, `Username`, `Password`, `Email`, `Approved`, `Pass_Link`, `Timestamp`) VALUES
(6, 'Arun Solanki', 'arun', '$2y$10$5DSyYbHo4GdH1M83Q5otzuE9In/rB6ODkPwkXK6U/Irhutp394vHO', 'gargsarthak30@gmail.com', 1, '', '2015-12-28 15:50:13'),
